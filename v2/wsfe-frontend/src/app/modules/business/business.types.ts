...
export const vouchersSQLServer: VoucherSQLServer[] = [];

export const voucherSQLServer: VoucherSQLServer = {
 ...
 * Only GADMCP
 */
export const _typeVoucherStatusSQLServer: TYPE_VOUCHER_STATUS_ENUM[] = [
  {
    name_type: '*',
    value_type: '*',
  },
