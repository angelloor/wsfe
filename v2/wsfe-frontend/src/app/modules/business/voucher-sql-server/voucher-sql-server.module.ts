...
import { voucherSQLServerRoutes } from './voucher-sql-server.routing';

@NgModule({
  declarations: [VoucherSQLServerListComponent, VoucherSQLServerComponent],
  imports: [
    RouterModule.forChild(voucherSQLServerRoutes),
    MatButtonModule,
    MatCheckboxModule,
    MatDatepickerModule,
    MatDividerModule,
...
export class VoucherSQLServerModule {}
