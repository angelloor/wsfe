...
import { RememberMe, RememberMeVisitor } from 'app/core/app/app.type';
...
// sign_in_visitor
export const SET_SIGN_IN_VISITOR = '[SIGN_IN_VISITOR] SET SIGN_IN_VISITOR';
export const RESET_SIGN_IN_VISITOR = '[SIGN_IN_VISITOR] RESET SIGN_IN_VISITOR';

export const setSignInVisitor = createAction(SET_SIGN_IN_VISITOR);
export const resetSignInVisitor = createAction(RESET_SIGN_IN_VISITOR);
...
// RememberMeVisitor
export const ENABLED_REMEMBERME_VISITOR = '[REMEMBERME_VISITOR] ENABLED';
export const DISABLED_REMEMBERME_VISITOR = '[REMEMBERME_VISITOR] DISABLED';

export const enabledRememberMeVisitor = createAction(
  ENABLED_REMEMBERME_VISITOR,
  props<RememberMeVisitor>()
);
export const disabledRememberMeVisitor = createAction(
  DISABLED_REMEMBERME_VISITOR
);

// query_environment
export const QUERY_ENVIRONMENT_TEST = '[QUERY_ENVIRONMENT] TEST';
export const QUERY_ENVIRONMENT_PRODUCTION = '[QUERY_ENVIRONMENT] PRODUCTION';

export const enabledEnvironmentTest = createAction(QUERY_ENVIRONMENT_TEST);
export const enabledEnvironmentProduction = createAction(
  QUERY_ENVIRONMENT_PRODUCTION
);
// User
